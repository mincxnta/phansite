...
export const MusicPlayer = () => {
  ...
  return (
    <>
      ...
      {isPlayerOpen && (
        <div className="-skew-x-3 fixed w-90 bottom-8 right-5 md:right-10 z-100 bg-white p-4 border-8 border-black text-black flex flex-col sm:flex-row items-center gap-2 sm:min-w-[35em]"
        >
